...
tr.mu.sp <- function(stepsize = 0.1, branchstop = 200, seqlen = 2000, traitstart = 50, trait.r = 0, regcoefmu = 0.7, regcoefspr = 3.15, Pext = 0.01, D = 10, molerror = 0.0005, sprerror = 0.05, direct = F, covariance = 25e-6, meanmu = -4.6, meanspr = -2.3, q = 0, age = 0){
